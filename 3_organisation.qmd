...
3.1](#figure31) aufgebaut.

![Abb. 3.1: Grundkategorien des SGMM [@Ruegg-Sturm2003-ga, S. 22],
Quelle: <https://de.wikipedia.org/wiki/Datei:SGMM2.jpg> (CC Public
Domain)](images/figure31.jpeg){#figure31}
...
[Abb. 3.2](#figure32) dargestellt, werden im Organigramm unterhalb der
...
![Abb. 3.2: Beispiel für ein Einlinienorganisation (Bernd Bosch, CC
BY-SA 3.0), Quelle:
<https://commons.wikimedia.org/wiki/File:Einliniensystem.jpg> (CC Public
Domain)](images/figure32.jpg){#figure32}
...
drei Hierarchien bzw. Organisationsebenen dargestellt (vgl. [Abb.
3.3](#figure33)).

![Abb. 3.3: Mehrlinienorganisation [eigene Darstellung, nach
@Thommen2000-kd, S. 696)]](images/figure33.png){#figure33}
...
![Abb. 3.4: Typische Stablinienorganisation anhand eines Organigramm
eines sozialen Trägers [nach @Liedke_2017, S.
124]](images/figure34.png){#figure34}

In der [Abb 3.4](#figure34) sind beispielsweise Stabsstellen für
...
![Abb. 3.5: Matrixorganisation (Wagner, 2004, *Skizze einer
Matrixorganisation*,
<https://upload.wikimedia.org/wikipedia/de/c/cb/Matrixorganisation.png>
(Public Domain))](images/figure35.png){#figure35}

Die [Abb. 3.5](#figure35) zeigt ein Unternehmen aus dem produzierenden
...
und Stabslinienorganisation dar (vgl. [Abb. 3.6](#figure36)).

![Abb. 3.6: Produktgruppen-Organisation mit zentralen Abteilungen [nach
@Muller-Scholl1992-bt, S. 87] zit . n. [@woehrle2012a, S.
34])](images/figure36.png){#figure36}
...
Prozessmanagements in sieben Phasen untergliedern (vgl. [Abb. 3.7](#figure37)).

![Abb. 3.7: Phasen des Prozessmanagements [nach
@Schiersmann2014, S. 348-350]](images/figure37.png){#figure37}
...
## 4.2 Aufgabenfolgeplan bzw. Flussdiagramm (Flowcharts) {#aufgabenfolgeplan-bzw-flussdiagramm-flowcharts}
...
![Abb. 3.7: Flowchart Ideenprämierung (Hagenmaier, CC-BY-SA 3.0)](images/figure38.jpg){#figure38}
...
![Abb. 3.9: Schema einer Prozesslandkarte [nach
@Liedke_2017, S. 155]](images/figure39.png){#figure39}

In dem in [Abb. 3.9](#figure39) dargestellten Beispiel gibt es
...
![Abb. 3.10: Prozesslandkarte Erstgespräch zur Bestimmung des Betreuungsbedarfs in
ambul. Altenhilfe [nach
@Liedke_2017, S. 157]](images/figure310.png){#figure310}

In [Abb. 3.10](#n3mqgwbmxts) wird ein relativ komplexer Prozess,
...
([Abb. 3.11](#figure311)) visualisiert, wobei das verwendete
...
![Abb. 3.11: Integrated Culture Framewor [Credits: Spencer Stuart, In:
@Groysberg_Lee_Price_Chen_2018a, S. 47]](images/figure311.png){#figure311}
...
## 6.2 Was ist Organisationsanalyse?
...
personenrelevante Informationen [vgl. @woehrle2012a, S. 24] ([Abb.
3.12](#figure312)). Es sind sozusagen die Mitarbeitenden und die
...
![Abb. 3.12: Erfolgsfaktoren im Rahmen der Organisationsentwicklung [Röder 1999, zit. n. @woehrle2012a, S. 24]](images/figure312.png){#figure312}
...
[Abb. 3.13](#figure313) [@woehrle2012a, S. 9], die zwischen der ersten und der
zweiten Ordnung unterscheidet.

![Abb. 3.13: Organisationswandel 1. und 2. Ordnung [nach @woehrle2012a, S. 9]](images/figure313.png){#figure313}

In [Abb. 3.13](#figure313) zum Kultur- bzw.
...
darzustellen. Hierfür folgendes Beispiel in [Abb. 3.14](#figure314) für eine sogenannte
...
![Abb. 3.14: Beispiel für eine Prozessarchitektur [@Schiersmann2014, S. 51]](images/figure314.png){#figure314}
...
![Abb. 3.15: Kräfte-Analyse von Lewin [nach Becker & Langosch, 2002, zit n. @kolhoff2009, S. 23]](images/figure315.png){#figure315}

In [Abb. 3.15](#figure315) ist ein Kräftefeld dargestellt. Die
...
erneuten Start dieses Prozesses sein kann (vgl. [Abb. 3.16](#figure316])).

![Abb. 3.16: Aktionsforschung [nach Lewin zit n. @kolhoff2009, S. 23]](images/figure316.png){#figure316}
...
unterschieden (vgl. [Abb. 3.17](#figure317)).

![Abb. 3.17: Organisationsentwicklung und Change-Management nach Kurt Lewins
3-Phasen-Modell (eigene Darstellung)](images/figure317.png){#figure317}
